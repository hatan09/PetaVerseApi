...
namespace PetaVerseApi.Core.Migrations
{
    ...
    [Migration("20220817081438_Animal_DateOfBirth")]
    partial class Animal_DateOfBirth
    {
            ...
            modelBuilder.Entity("PetaVerseApi.Core.Entities.Animal", b =>
                {
                    ...
                    b.HasOne("PetaVerseApi.Core.Entities.PetaverseMedia", "PetAvatar")
                        .WithMany()
                        .HasForeignKey("PetAvatarId");

                    b.Navigation("Breed");

                    b.Navigation("PetAvatar");
                });
